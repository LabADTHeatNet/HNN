...
class EdgeRegressorNetwork(nn.Module):
    def __init__(self,
                 node_in_channels,
        ...
        self.mlp_out = nn.Sequential(
            nn.Linear(edge_hidden_channels + 2 * node_repr_dim, edge_hidden_channels),
            nn.ReLU(),
