...
\textcolor{blue}{Recent studies on water and gas distribution systems show why
	...
	interconnected network components. Inspired by these findings, this paper
...
pipes. Five defect severity levels were considered, corresponding to increased
heat transfer in the ranges 120--150\%, 150--170\%, 170--200\%, 200--300\%,
and 300--400\% of the baseline $\alpha$ value.
...
\textcolor{blue}{Figure~\ref{fig:pred_distribution} should be interpreted as
	a marginal class-count diagnostic rather than as a direct measure of
	class-wise localization accuracy. Similar true and predicted counts can still
	hide compensating errors between neighbouring sections. Therefore, the
	distribution plot is considered together with the confusion matrices in
	Figures~\ref{fig:confusion_matrix_fwd} and~\ref{fig:confusion_matrix_bwd},
	which show the actual class-to-class error structure.}

\begin{figure}[H]
	\begin{adjustwidth}{-\extralength}{0cm}
		\centering
		\includegraphics[width=16.0cm]{Figures/fwd_result_confusion_matrix_normalized.png}
	\end{adjustwidth}
	\caption{Confusion matrix for the supply subnet, excluding the "no defect" class.
		\label{fig:confusion_matrix_fwd}}
\end{figure}

\begin{figure}[H]
	\begin{adjustwidth}{-\extralength}{0cm}
		\centering
		\includegraphics[width=16.0cm]{Figures/bwd_result_confusion_matrix_normalized.png}
	\end{adjustwidth}
	\caption{Confusion matrix for the return subnet, excluding the "no defect" class.
		\label{fig:confusion_matrix_bwd}}
\end{figure}

\textcolor{blue}{The distribution of predicted classes and the corresponding confusion matrices
on Figures~\ref{fig:pred_distribution}, \ref{fig:confusion_matrix_fwd},
and~\ref{fig:confusion_matrix_bwd} support
