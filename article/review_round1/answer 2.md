...
Response 13: We added a reference for the Adam optimizer in Section 2.6, Training, in the sentence introducing the optimizer. The optimizer settings were already specified in the same subsection, including the initial learning rate, beta values, epsilon, weight decay, and learning-rate scheduler parameters.
